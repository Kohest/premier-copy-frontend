...
const TextWithTitleSkeleton = () => (
  ...
  >
    ...
    <rect x="10" y="0" rx="13" ry="13" width="564" height="64" />
    ...
    <rect x="117" y="79" rx="13" ry="13" width="356" height="22" />
    <rect x="17" y="119" rx="13" ry="13" width="543" height="22" />
  </ContentLoader>
);

export default TextWithTitleSkeleton;
